              ...
              <div>
                ...
                <div className="flex gap-2 text-neutral-400 w-20 h-20 items-center justify-center">
                  ...
                  <FaMinus
                    ...
                    className="transition hover:text-neutral-600 cursor-pointer"
                    onClick={() => handleDecreaseQuantity(cartProduct.url)} />
>>>>>>> parent of 95bb9ad (fixed image array not passed correctly in shopping cart)
                </div>
              </div>
              );
              })}
            </div><div className="border-2 border-[#cbcbcb] sm:min-w-120 lg:min-w-150 xl:min-w-200 bg-[#f1f1f1] p-8 mt-10">
